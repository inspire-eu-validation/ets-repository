...
declare namespace hh='http://inspire.ec.europa.eu/schemas/hh/5.0';
declare namespace ef='http://inspire.ec.europa.eu/schemas/ef/4.0';
declare namespace mr-core='http://inspire.ec.europa.eu/schemas/mr-core/4.0';
declare namespace pf='http://inspire.ec.europa.eu/schemas/pf/4.0';
declare namespace nz-core	='http://inspire.ec.europa.eu/schemas/nz-core/5.0'; 
declare namespace elu='http://inspire.ec.europa.eu/schemas/elu/4.0';
declare namespace er-b='http://inspire.ec.europa.eu/schemas/er-b/4.0';
declare namespace er-c='http://inspire.ec.europa.eu/schemas/er-c/4.0';
declare namespace er-v='http://inspire.ec.europa.eu/schemas/er-v/4.0';
...
declare namespace hy-p='http://inspire.ec.europa.eu/schemas/hy-p/5.0'; 
declare namespace au='http://inspire.ec.europa.eu/schemas/au/5.0'; 
...
declare namespace el-cov='http://inspire.ec.europa.eu/schemas/el-cov/5.0';
declare namespace el-tin='http://inspire.ec.europa.eu/schemas/el-tin/5.0';
declare namespace el-vec='http://inspire.ec.europa.eu/schemas/el-vec/5.0'; 
...
declare namespace lcv='http://inspire.ec.europa.eu/schemas/lcv/5.0';
declare namespace hb='http://inspire.ec.europa.eu/schemas/hb/4.0';
declare namespace mu='http://inspire.ec.europa.eu/schemas/mu/4.0';
...
declare namespace so='http://inspire.ec.europa.eu/schemas/so/4.0'; 
declare namespace sr='http://inspire.ec.europa.eu/schemas/sr/4.0'; 
declare namespace su-core='http://inspire.ec.europa.eu/schemas/su-core/4.0'; 
declare namespace su-grid='http://inspire.ec.europa.eu/schemas/su-grid/4.0'; 
declare namespace su-vector='http://inspire.ec.europa.eu/schemas/su-vector/4.0'; 
...
declare namespace tn-ra='http://inspire.ec.europa.eu/schemas/tn-ra/5.0';
declare namespace tn-ro='http://inspire.ec.europa.eu/schemas/tn-ro/5.0';
declare namespace tn-w='http://inspire.ec.europa.eu/schemas/tn-w/5.0';
declare namespace us-net-common='http://inspire.ec.europa.eu/schemas/us-net-common/5.0';
declare namespace us-net-el='http://inspire.ec.europa.eu/schemas/us-net-el/5.0';
declare namespace us-net-ogc='http://inspire.ec.europa.eu/schemas/us-net-ogc/5.0';
declare namespace us-net-sw='http://inspire.ec.europa.eu/schemas/us-net-sw/5.0';
declare namespace us-net-th='http://inspire.ec.europa.eu/schemas/us-net-th/5.0';
declare namespace us-net-wa='http://inspire.ec.europa.eu/schemas/us-net-wa/5.0';
declare namespace us-govserv='http://inspire.ec.europa.eu/schemas/us-govserv/5.0';
...
declare function local:getXSDSchemaWithVersion( $themeid as xs:string*, $themexsdname as xs:string*, $version as xs:string* ) as xs:string*
{
  let $themeschemas:= for $t at $pos in $themeid
                        return concat("<xs:import namespace='http://inspire.ec.europa.eu/schemas/", string($themeid[$pos]), "/", string($version[$pos]) ,"' schemaLocation='http://inspire.ec.europa.eu/schemas/",string($themeid[$pos]),
                        "/",string($version[$pos]),  "/", string($themexsdname[$pos]) ,".xsd'/>")
