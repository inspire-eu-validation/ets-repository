...
declare variable $projDir external := "\Users\vandeloc\Documents\Documents\ARE3NA\ets-repository\inspire";
...
declare variable $dbBaseName external := "cadastralparcel-ABENGIBRE";
declare variable $dbCount external := 1;
declare variable $etsFile external := $projDir || file:dir-separator() || "data-cp" || file:dir-separator() || "cp-rs" || file:dir-separator() || "ets-cp-rs-bsxets.xml";
(: Project internals :)
